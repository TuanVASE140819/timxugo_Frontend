  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        ...
        {!hintUsed ? (
          <>
            <p className="text-center py-4">Bạn có muốn sử dụng một gợi ý không?</p>
            <DialogFooter>
              <Button onClick={useHint} className="w-full">Sử dụng gợi ý</Button>
            </DialogFooter>
          </>
        ) : (
          <>
            <p className="text-center py-4">Kho báu gần bạn nhất cách khoảng 500 mét.</p>
            <DialogFooter>
